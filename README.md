...
This repository contains the code and data relevant to final version of my diploma thesis titled: **"Learning Explainable Model of Spiral Compression in Spirography"**.
