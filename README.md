...
This repository contains the code and data relevant to final version of my diploma thesis titled: **"Training an Explainable Model of Spiral Compression in Spirography"**. Also checkout the [Web App + Backend API repository](https://github.com/TheLegend442/spirals_vis_api).
